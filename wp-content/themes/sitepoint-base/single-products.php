			...
			<div class="grid-100 tablet-grid-100">
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div class="singleproduct-right">
                        ...
                        <div class="singleproduct-file"><img src="http://meltal.oss-dev.av-studio.si/metrapan/wp-content/uploads/2017/04/file.png"><a href="<?php echo $file; ?>">Prenesi dokumentacijo</a></div>
						<hr class="singleproduct-seperator">
